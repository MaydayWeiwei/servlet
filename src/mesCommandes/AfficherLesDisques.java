...
public class AfficherLesDisques extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<h3>" + "Bonjour " + nom.toUpperCase()
				+ " vous pouvez commander un disque" + "</h3>");

		// ********************************************************************************************
		// Appel de la méthode. afficherVenteDisques de Paniers, avec trois
		// paramètres :
		// - un Iterateur sur les disques disponibles dans le magasin
		// (obtenu en demandant l'itérateur de la liste de stockDisponible)
		// - le « PrintWriter » pour pouvoir rajouter ces disques dans la page
		// de la réponse HTML,
		// - et le repertoire courant de votre application
		// "request.getContextPath()"
		//
		// ********************************************************************************************

		Paniers.afficherVenteDisques(stockDisponible.getListeDisques()
				.iterator(), out, request.getContextPath());
